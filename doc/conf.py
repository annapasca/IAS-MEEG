...
latex_documents = [
    (master_doc, 'IAS.tex', 'public\\_matlab\\_code Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'IAS', 'IAS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IAS', 'IAS Documentation',
     author, 'IAS', 'One line description of project.',
     'Miscellaneous'),
]
